package com.cc.smartx.javanio.zhss.socket.demo04;
...
public class NIOServer {
    ...
    private static void init(){  
        ...
        try {  
        	...
        	serverSocketChannel.socket().bind(new InetSocketAddress(9000), 100); // 同时间连接建立请求数量，默认50
        ...
        while(true){  
            try{  
                ...
                while(keysIterator.hasNext()){  
                    ...
                    keysIterator.remove();
                    // TODO 不能直接把SelectionKey放到队列里，可能存在多个线程操作一个SocketChannel，只能SocketChannel放到队列里
