package com.cc.smartx.algorithm.zuochengyun.stage03.class06;
...
public class Problem02_BSTtoDoubleLinkedList {
	...
	public static RetrunType process(Node X) {
		if (X == null) {
			return new RetrunType(null, null);
		}
		RetrunType leftHeadEnd = process(X.left);
		RetrunType rightHeadEnd = process(X.right);	
		...
		return new RetrunType(leftHeadEnd.start != null ? leftHeadEnd.start : X,
